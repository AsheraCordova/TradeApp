...
export abstract class UITextViewLabelImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
	...
	@Type(() => CommandAttr)
	@Expose({ name: "iosUsesStandardTextScaling" })
	iosUsesStandardTextScaling!:CommandAttr<boolean>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "iosIsEditable" })
...
export class UITextViewLabel extends UITextViewLabelImpl<UITextViewLabel> implements IWidget{
    getThisPointer(): UITextViewLabel {
        return this;
    }
    
   	public getClass() {
		return UITextViewLabel;
	}
...
UITextViewLabelImpl.initialize();
