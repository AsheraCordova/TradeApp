...
- (instancetype)init {
  ASDimensionDpPxIntConverter_init(self);
  return self;
}
...
- (JavaLangInteger *)convertFromWithId:(NSString *)dimen
  ...
  if (dimen != nil) {
    ...
    if ([((NSString *) nil_chk(dimen)) java_hasSuffix:@"px"]) {
      ...
      @throw create_JavaLangRuntimeException_initWithNSString_(@"The dimension can be match_parent/wrap_content or should be expressed in dp/px");
    }
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ASDimensionDpPxIntConverter = { "DimensionDpPxIntConverter", "com.ashera.converter", ptrTable, methods, NULL, 7, 0x1, 4, 0, -1, -1, -1, 6, -1 };
  return &_ASDimensionDpPxIntConverter;
}

@end

void ASDimensionDpPxIntConverter_init(ASDimensionDpPxIntConverter *self) {
  NSObject_init(self);
}

ASDimensionDpPxIntConverter *new_ASDimensionDpPxIntConverter_init() {
  J2OBJC_NEW_IMPL(ASDimensionDpPxIntConverter, init)
}

ASDimensionDpPxIntConverter *create_ASDimensionDpPxIntConverter_init() {
  J2OBJC_CREATE_IMPL(ASDimensionDpPxIntConverter, init)
}
