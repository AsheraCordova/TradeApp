...
export abstract class CheckBoxStyledLabelImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
...
export class CheckBoxStyledLabel extends CheckBoxStyledLabelImpl<CheckBoxStyledLabel> implements IWidget{
    getThisPointer(): CheckBoxStyledLabel {
        return this;
    }
    
   	public getClass() {
		return CheckBoxStyledLabel;
	}
...
CheckBoxStyledLabelImpl.initialize();
