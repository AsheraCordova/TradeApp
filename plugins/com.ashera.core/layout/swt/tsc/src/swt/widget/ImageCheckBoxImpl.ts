...
export abstract class ImageCheckBoxImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
...
export class ImageCheckBox extends ImageCheckBoxImpl<ImageCheckBox> implements IWidget{
    getThisPointer(): ImageCheckBox {
        return this;
    }
