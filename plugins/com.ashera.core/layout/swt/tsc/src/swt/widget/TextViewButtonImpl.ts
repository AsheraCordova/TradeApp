...
export abstract class TextViewButtonImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
...
export class TextViewButton extends TextViewButtonImpl<TextViewButton> implements IWidget{
    getThisPointer(): TextViewButton {
        return this;
    }
