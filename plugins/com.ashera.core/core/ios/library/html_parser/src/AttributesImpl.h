...
#ifdef RESTRICT_AttributesImpl
#define INCLUDE_ALL_AttributesImpl 0
#else
#define INCLUDE_ALL_AttributesImpl 1
#endif
#undef RESTRICT_AttributesImpl

#if !defined (TSAttributesImpl_) && (INCLUDE_ALL_AttributesImpl || defined(INCLUDE_TSAttributesImpl))
#define TSAttributesImpl_
...
J2OBJC_EMPTY_STATIC_INIT(TSAttributesImpl)

J2OBJC_FIELD_SETTER(TSAttributesImpl, data_, IOSObjectArray *)

FOUNDATION_EXPORT void TSAttributesImpl_init(TSAttributesImpl *self);

FOUNDATION_EXPORT TSAttributesImpl *new_TSAttributesImpl_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT TSAttributesImpl *create_TSAttributesImpl_init(void);

FOUNDATION_EXPORT void TSAttributesImpl_initWithOrgXmlSaxAttributes_(TSAttributesImpl *self, id<OrgXmlSaxAttributes> atts);

FOUNDATION_EXPORT TSAttributesImpl *new_TSAttributesImpl_initWithOrgXmlSaxAttributes_(id<OrgXmlSaxAttributes> atts) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT TSAttributesImpl *create_TSAttributesImpl_initWithOrgXmlSaxAttributes_(id<OrgXmlSaxAttributes> atts);
...
#pragma pop_macro("INCLUDE_ALL_AttributesImpl")
