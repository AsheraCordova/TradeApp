	...
	public class RadioButtonExt extends MeasurableCompoundButton implements ILifeCycleDecorator{
        ...
        protected void setTextSizeInternal(int unit, float optimalTextSize, boolean b) {
		 ...
		 public void onRtlPropertiesChanged(int layoutDirection) {
			 RadioButtonImpl.this.onRtlPropertiesChanged(layoutDirection);
		 }
        @Override
        public int nativeMeasureWidth(java.lang.Object uiView) {
        	return RadioButtonImpl.this.nativeMeasureWidth(uiView);
        }
...
return this;}
public RadioButtonCommandBuilder setButtonSize(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonCommandBuilder setButtonPadding(String value) {
...
public void setChecked(boolean value) {
	...
	public void addCheckedListener(Object listener, String id) {
		ViewImpl.setOnListener(this, button, (org.teavm.jso.dom.events.EventListener<org.teavm.jso.dom.events.Event>) listener, id, "change");
	}
