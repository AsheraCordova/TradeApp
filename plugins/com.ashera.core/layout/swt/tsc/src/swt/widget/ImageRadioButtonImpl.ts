...
export abstract class ImageRadioButtonImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
...
export class ImageRadioButton extends ImageRadioButtonImpl<ImageRadioButton> implements IWidget{
    getThisPointer(): ImageRadioButton {
        return this;
    }
...
ImageRadioButtonImpl.initialize();
