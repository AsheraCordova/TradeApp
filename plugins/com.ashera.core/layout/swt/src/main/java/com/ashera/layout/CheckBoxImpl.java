...
@SuppressLint("NewApi")
public class CheckBoxImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, com.ashera.validations.FormElement{
	//start - body
...
public CheckBoxCommandBuilder tryGetSwtImage() {
...
public CheckBoxCommandBuilder setSwtImage(String value) {
	Map<String, Object> attrs = initCommand("swtImage");
	attrs.put("type", "attribute");
...
return this;}
public CheckBoxCommandBuilder tryGetSwtText() {
...
public CheckBoxCommandBuilder setSwtText(String value) {
	Map<String, Object> attrs = initCommand("swtText");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public CheckBoxCommandBuilder setOnCheckedChange(String value) {
	...
	attrs.put("value", value);
return this;}
public CheckBoxCommandBuilder setSwtCheckBoxHorizontalPadding(String value) {
