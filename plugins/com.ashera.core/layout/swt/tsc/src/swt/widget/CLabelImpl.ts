...
export abstract class CLabelImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
...
export class CLabel extends CLabelImpl<CLabel> implements IWidget{
    getThisPointer(): CLabel {
        return this;
    }
