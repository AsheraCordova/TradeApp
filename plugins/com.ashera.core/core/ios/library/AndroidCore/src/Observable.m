...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ADObservable = { "Observable", "r.android.database", ptrTable, methods, fields, 7, 0x401, 4, 1, -1, -1, -1, 5, -1 };
  return &_ADObservable;
}

@end

void ADObservable_init(ADObservable *self) {
  NSObject_init(self);
