...
//end - imports
@SuppressLint("NewApi")
public class CLabelImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth, com.ashera.validations.ValidationErrorLabel {
	//start - body
	public final static String LOCAL_NAME = "CLabel"; 
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("CLabel.font", new Font());
		...
		ConverterFactory.register("CLabel.ellipsize", new Ellipsize());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("ellipsize").withType("CLabel.ellipsize"));
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("startOrStopMarquee").withType("boolean"));
		ConverterFactory.register("CLabel.marqueeRepeatLimit", new MarqueeRepeatLimit());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("marqueeRepeatLimit").withType("CLabel.marqueeRepeatLimit"));
	...
	public class CLabelExt extends MeasurableTextView implements ILifeCycleDecorator{
        ...
        public boolean suggestedSizeFitsInSpace(int mAutoSizeTextSizeInPx, r.android.graphics.RectF availableSpace) {
        	return CLabelImpl.this.suggestedSizeFitsInSpace(mAutoSizeTextSizeInPx, availableSpace.width(), availableSpace.height());
        }
        
        @Override
        protected void setTextSizeInternal(int unit, float optimalTextSize, boolean b) {
        	CLabelImpl.this.setMyTextSize(optimalTextSize);
        }
		  public int getBorderPadding(){
		    return CLabelImpl.this.getBorderPadding();
		  }

		  public int getLineHeight(){
		    return CLabelImpl.this.getLineHeight();
		  }

		  public int getBorderWidth(){
		    return CLabelImpl.this.getBorderWidth();
		  }
		  public int getLineHeightPadding(){
		    return CLabelImpl.this.getLineHeightPadding();
		  }
		 @Override
		 public void onRtlPropertiesChanged(int layoutDirection) {
			 CLabelImpl.this.onRtlPropertiesChanged(layoutDirection);
		 }
	}	
	public void updateMeasuredDimension(int width, int height) {
		((CLabelExt) measurableTextView).updateMeasuredDimension(width, height);
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableTextView = new CLabelExt();
		nativeCreate(params);	
	...
	public void setAttribute(WidgetAttribute key, String strValue, Object objValue, ILifeCycleDecorator decorator) {
		...
		disposeAll(cLabel.getImage());
		 cLabel.setImage((Image)objValue);
		 ...
		 cLabel.setText((String)objValue);
...
return getLastBaselineToBottomHeight();				}
	...
	private void nativeCreate(Composite parent, Map<String, Object> params) {
		...
		cLabel = createCLabel(wrapperComposite, textStyle);
		
		computeLineHeight();
		cLabel.addDisposeListener((e) -> {
        	disposeAll(newFont, cLabel.getImage());
        	cancelTimer();
        });
	...
	private void setHorizontalAligmentCenter() {
		cLabel.setAlignment(TEXT_ALIGN_CENTER);
	}

	private void setHorizontalAligmentRight() {
		cLabel.setAlignment(org.eclipse.swt.SWT.RIGHT);
	}

	private void setHorizontalAligmentLeft() {
		cLabel.setAlignment(org.eclipse.swt.SWT.LEFT);
	}
	//end - aligment
	...
	private int computeSize(float width) {
		return measurableTextView.nativeMeasureHeight(cLabel, (int) width);
	}
	...
	private void setEnabled(Object objValue) {
		cLabel.setEnabled((boolean) objValue);
	}
	//end - enabled
    ...
    public List<Object> getNativeWidgets() {
		return java.util.Arrays.asList(wrapperComposite, cLabel, drawableBottom, drawableLeft, drawableTop, drawableRight).
	...
	public int measureHeight(int width) {
		...
		return cLabel.computeSize(width, org.eclipse.swt.SWT.DEFAULT).y + wrapperCompositeHeight;
	}

	@Override
	public int measureWidth() {
		int wrapperCompositeWidth = wrapperComposite.computeSize(org.eclipse.swt.SWT.DEFAULT, org.eclipse.swt.SWT.DEFAULT).y;
		return cLabel.computeSize(org.eclipse.swt.SWT.DEFAULT, org.eclipse.swt.SWT.DEFAULT).x + wrapperCompositeWidth;
	}
	//end - dimenmeasure
	...
	private void setEllipsize(Object objValue, String strValue) {
		cLabel.setData("ellipsize", (int) objValue);
	...
	private Object getEllipsize() {
		return cLabel.getData("ellipsize");
	}
	//end - ellipsize
...
//		timer = null;
	...
	private boolean canMarquee() {
		return (cLabel.getStyle() & org.eclipse.swt.SWT.WRAP) == 0 && !html;
	}
	//end - marquee
	...
	private void computeLineHeight() {
		lineHeight = cLabel.computeSize(20, org.eclipse.swt.SWT.DEFAULT).y;
	}
	public int getLineHeight() {
		return lineHeight;
	}
...
public CLabelBean getBean() {
	if (bean == null) {
		bean = new CLabelBean();
	}
	return bean;
}
public CLabelCommandBuilder getBuilder() {
	if (builder == null) {
		builder = new CLabelCommandBuilder();
	}
	return builder;
}


public  class CLabelCommandBuilder extends com.ashera.layout.ViewImpl.ViewCommandBuilder <CLabelCommandBuilder> {
    public CLabelCommandBuilder() {
	}
	
	public CLabelCommandBuilder execute(boolean setter) {
		if (setter) {
...
public CLabelCommandBuilder tryGetSwtImage() {
...
public CLabelCommandBuilder setSwtImage(String value) {
	Map<String, Object> attrs = initCommand("swtImage");
	attrs.put("type", "attribute");
...
return this;}
public CLabelCommandBuilder tryGetSwtText() {
...
public CLabelCommandBuilder setSwtText(String value) {
	Map<String, Object> attrs = initCommand("swtText");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetText() {
...
public CLabelCommandBuilder setText(String value) {
	Map<String, Object> attrs = initCommand("text");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetTextColor() {
...
public CLabelCommandBuilder setTextColor(String value) {
	Map<String, Object> attrs = initCommand("textColor");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetGravity() {
...
public CLabelCommandBuilder setGravity(String value) {
	Map<String, Object> attrs = initCommand("gravity");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetTextSize() {
...
public CLabelCommandBuilder setTextSize(String value) {
	Map<String, Object> attrs = initCommand("textSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setPadding(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingBottom() {
...
public CLabelCommandBuilder setPaddingBottom(String value) {
	Map<String, Object> attrs = initCommand("paddingBottom");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingRight() {
...
public CLabelCommandBuilder setPaddingRight(String value) {
	Map<String, Object> attrs = initCommand("paddingRight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingLeft() {
...
public CLabelCommandBuilder setPaddingLeft(String value) {
	Map<String, Object> attrs = initCommand("paddingLeft");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingStart() {
...
public CLabelCommandBuilder setPaddingStart(String value) {
	Map<String, Object> attrs = initCommand("paddingStart");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingEnd() {
...
public CLabelCommandBuilder setPaddingEnd(String value) {
	Map<String, Object> attrs = initCommand("paddingEnd");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetPaddingTop() {
...
public CLabelCommandBuilder setPaddingTop(String value) {
	Map<String, Object> attrs = initCommand("paddingTop");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setPaddingHorizontal(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setPaddingVertical(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMinLines() {
...
public CLabelCommandBuilder setMinLines(int value) {
	Map<String, Object> attrs = initCommand("minLines");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setLines(int value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMaxLines() {
...
public CLabelCommandBuilder setMaxLines(int value) {
	Map<String, Object> attrs = initCommand("maxLines");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMinWidth() {
...
public CLabelCommandBuilder setMinWidth(String value) {
	Map<String, Object> attrs = initCommand("minWidth");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMinHeight() {
...
public CLabelCommandBuilder setMinHeight(String value) {
	Map<String, Object> attrs = initCommand("minHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMaxWidth() {
...
public CLabelCommandBuilder setMaxWidth(String value) {
	Map<String, Object> attrs = initCommand("maxWidth");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMaxHeight() {
...
public CLabelCommandBuilder setMaxHeight(String value) {
	Map<String, Object> attrs = initCommand("maxHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetHeight() {
...
public CLabelCommandBuilder setHeight(String value) {
	Map<String, Object> attrs = initCommand("height");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetWidth() {
...
public CLabelCommandBuilder setWidth(String value) {
	Map<String, Object> attrs = initCommand("width");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMaxEms() {
...
public CLabelCommandBuilder setMaxEms(int value) {
	Map<String, Object> attrs = initCommand("maxEms");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMinEms() {
...
public CLabelCommandBuilder setMinEms(int value) {
	Map<String, Object> attrs = initCommand("minEms");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setEms(int value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setTypeface(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setTextStyle(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setFontFamily(String value) {
...
public CLabelCommandBuilder setDrawableStart(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setDrawableEnd(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setDrawableTop(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setDrawableBottom(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetDrawablePadding() {
...
public CLabelCommandBuilder setDrawablePadding(String value) {
	Map<String, Object> attrs = initCommand("drawablePadding");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public CLabelCommandBuilder setAutoSizeTextType(String value) {
	Map<String, Object> attrs = initCommand("autoSizeTextType");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetAutoSizeMaxTextSize() {
...
public CLabelCommandBuilder setAutoSizeMaxTextSize(String value) {
	Map<String, Object> attrs = initCommand("autoSizeMaxTextSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetAutoSizeMinTextSize() {
...
public CLabelCommandBuilder setAutoSizeMinTextSize(String value) {
	Map<String, Object> attrs = initCommand("autoSizeMinTextSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetAutoSizeStepGranularity() {
...
public CLabelCommandBuilder setAutoSizeStepGranularity(String value) {
	Map<String, Object> attrs = initCommand("autoSizeStepGranularity");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setMaxLength(int value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setEnabled(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setEditable(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setSingleLine(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setTextAllCaps(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setPassword(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setScrollHorizontally(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetEllipsize() {
...
public CLabelCommandBuilder setEllipsize(String value) {
	Map<String, Object> attrs = initCommand("ellipsize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setStartOrStopMarquee(boolean value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetMarqueeRepeatLimit() {
...
public CLabelCommandBuilder setMarqueeRepeatLimit(String value) {
	Map<String, Object> attrs = initCommand("marqueeRepeatLimit");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetFirstBaselineToTopHeight() {
...
public CLabelCommandBuilder setFirstBaselineToTopHeight(String value) {
	Map<String, Object> attrs = initCommand("firstBaselineToTopHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder tryGetLastBaselineToBottomHeight() {
...
public CLabelCommandBuilder setLastBaselineToBottomHeight(String value) {
	Map<String, Object> attrs = initCommand("lastBaselineToBottomHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setAutoSizePresetSizes(String value) {
	...
	attrs.put("value", value);
return this;}
public CLabelCommandBuilder setTextFormat(String value) {
...
public void setTextFormat(String value) {
	...
	private org.eclipse.swt.custom.CLabel createCLabel(Composite wrapperComposite, int style) {
		return new CLabelWithEllipsis(wrapperComposite, style);
