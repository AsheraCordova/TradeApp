...
public class TableLayoutImpl extends BaseHasWidgets {
	...
	private r.android.widget.TableLayout tableLayout;
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		tableLayout = new TableLayoutExt();
	...
	private void createLayoutParams(View view) {
		r.android.widget.TableLayout.LayoutParams layoutParams = (r.android.widget.TableLayout.LayoutParams) view.getLayoutParams();
		
		layoutParams = (r.android.widget.TableLayout.LayoutParams) view.getLayoutParams();
		if (layoutParams == null) {
			layoutParams = new r.android.widget.TableLayout.LayoutParams(-2, -2);
	...
	private r.android.widget.TableLayout.LayoutParams getLayoutParams(View view) {
		return (r.android.widget.TableLayout.LayoutParams) view.getLayoutParams();		
	}
	...
	public void setChildAttribute(IWidget w, WidgetAttribute key, String strValue, Object objValue) {
		View view = (View) w.asWidget();
		r.android.widget.TableLayout.LayoutParams layoutParams = getLayoutParams(view);
...
return layoutParams.weight;			}
	...
	public class TableLayoutExt extends r.android.widget.TableLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
			...
			ViewImpl.setDrawableBounds(TableLayoutImpl.this, l, t, r, b);
			ViewImpl.nativeMakeFrame(asNativeWidget(), l, t, r, b);
			replayBufferedEvents();
	        ViewImpl.redrawDrawables(TableLayoutImpl.this);
