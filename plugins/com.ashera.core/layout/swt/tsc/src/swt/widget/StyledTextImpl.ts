...
export abstract class StyledTextImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
	...
	reset() : T {	
		...
		this.swtBlockSelection = undefined;
		this.swtBottomMargin = undefined;
		this.swtCaretOffset = undefined;
	...
	public tryGetSwtBlockSelection() : T {
		this.resetIfRequired();
		if (this.swtBlockSelection == null || this.swtBlockSelection == undefined) {
			this.swtBlockSelection = new CommandAttr<boolean>()
		}
		
		this.swtBlockSelection.setGetter(true);
		this.orderGet++;
		this.swtBlockSelection.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public isSwtBlockSelection() : boolean {
		if (this.swtBlockSelection == null || this.swtBlockSelection == undefined) {
			this.swtBlockSelection = new CommandAttr<boolean>();
		}
		return this.swtBlockSelection.getCommandReturnValue();
	}
	public setSwtBlockSelection(value : boolean) : T {
		this.resetIfRequired();
		if (this.swtBlockSelection == null || this.swtBlockSelection == undefined) {
			this.swtBlockSelection = new CommandAttr<boolean>();
		}
		
		this.swtBlockSelection.setSetter(true);
		this.swtBlockSelection.setValue(value);
		this.orderSet++;
		this.swtBlockSelection.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
	...
	public tryGetSwtCaretOffset() : T {
		this.resetIfRequired();
		if (this.swtCaretOffset == null || this.swtCaretOffset == undefined) {
			this.swtCaretOffset = new CommandAttr<number>()
		}
		
		this.swtCaretOffset.setGetter(true);
		this.orderGet++;
		this.swtCaretOffset.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getSwtCaretOffset() : number {
		if (this.swtCaretOffset == null || this.swtCaretOffset == undefined) {
			this.swtCaretOffset = new CommandAttr<number>();
		}
		return this.swtCaretOffset.getCommandReturnValue();
	}
	public setSwtCaretOffset(value : number) : T {
		this.resetIfRequired();
		if (this.swtCaretOffset == null || this.swtCaretOffset == undefined) {
			this.swtCaretOffset = new CommandAttr<number>();
		}
		
		this.swtCaretOffset.setSetter(true);
		this.swtCaretOffset.setValue(value);
		this.orderSet++;
		this.swtCaretOffset.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
...
export class StyledText extends StyledTextImpl<StyledText> implements IWidget{
    getThisPointer(): StyledText {
        return this;
    }
