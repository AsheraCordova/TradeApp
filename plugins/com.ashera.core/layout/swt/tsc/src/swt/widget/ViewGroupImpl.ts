...
export abstract class ViewGroupImpl<T> extends ViewGroupModelImpl<T>{
	...
	reset() : T {	
		super.reset();
		this.swtBackgroundMode = undefined;
		this.swtLayoutDeferred = undefined;
	...
	public tryGetSwtBackgroundMode() : T {
		this.resetIfRequired();
		if (this.swtBackgroundMode == null || this.swtBackgroundMode == undefined) {
			this.swtBackgroundMode = new CommandAttr<string>()
		}
		
		this.swtBackgroundMode.setGetter(true);
		this.orderGet++;
		this.swtBackgroundMode.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getSwtBackgroundMode() : string {
		if (this.swtBackgroundMode == null || this.swtBackgroundMode == undefined) {
			this.swtBackgroundMode = new CommandAttr<string>();
		}
		return this.swtBackgroundMode.getCommandReturnValue();
	}
	public setSwtBackgroundMode(value : string) : T {
		this.resetIfRequired();
		if (this.swtBackgroundMode == null || this.swtBackgroundMode == undefined) {
			this.swtBackgroundMode = new CommandAttr<string>();
		}
		
		this.swtBackgroundMode.setSetter(true);
		this.swtBackgroundMode.setValue(value);
		this.orderSet++;
		this.swtBackgroundMode.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetSwtLayoutDeferred() : T {
		this.resetIfRequired();
		if (this.swtLayoutDeferred == null || this.swtLayoutDeferred == undefined) {
			this.swtLayoutDeferred = new CommandAttr<boolean>()
		}
		
		this.swtLayoutDeferred.setGetter(true);
		this.orderGet++;
		this.swtLayoutDeferred.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public isSwtLayoutDeferred() : boolean {
		if (this.swtLayoutDeferred == null || this.swtLayoutDeferred == undefined) {
			this.swtLayoutDeferred = new CommandAttr<boolean>();
		}
		return this.swtLayoutDeferred.getCommandReturnValue();
	}
	public setSwtLayoutDeferred(value : boolean) : T {
		this.resetIfRequired();
		if (this.swtLayoutDeferred == null || this.swtLayoutDeferred == undefined) {
			this.swtLayoutDeferred = new CommandAttr<boolean>();
		}
		
		this.swtLayoutDeferred.setSetter(true);
		this.swtLayoutDeferred.setValue(value);
		this.orderSet++;
		this.swtLayoutDeferred.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
