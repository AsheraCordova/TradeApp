...
public class CheckBoxImpl extends BaseWidget implements com.ashera.validations.FormElement, ICustomMeasureWidth {
	...
	public class CheckBoxExt extends MeasurableCompoundButton implements ILifeCycleDecorator{
        ...
        public boolean suggestedSizeFitsInSpace(int mAutoSizeTextSizeInPx, r.android.graphics.RectF availableSpace) {
        	return CheckBoxImpl.this.suggestedSizeFitsInSpace(mAutoSizeTextSizeInPx, availableSpace.width(), availableSpace.height());
        }
        
        @Override
        protected void setTextSizeInternal(int unit, float optimalTextSize, boolean b) {
        	CheckBoxImpl.this.setMyTextSize(optimalTextSize);
        }
...
return this;}
public CheckBoxCommandBuilder setButtonSize(String value) {
	Map<String, Object> attrs = initCommand("buttonSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public CheckBoxCommandBuilder setButtonPadding(String value) {
	Map<String, Object> attrs = initCommand("buttonPadding");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public void setButtonSize(String value) {
	getBuilder().reset().setButtonSize(value).execute(true);
}

public void setButtonPadding(String value) {
	getBuilder().reset().setButtonPadding(value).execute(true);
}
