...
@implementation ASDictionaryMap_Entry
...
@implementation ASDictionaryMap
...
- (id<JavaUtilSet>)entrySet {
  ...
  for (id key in dictionary_) {
      ASDictionaryMap_Entry *entry =
        AUTORELEASE([[ASDictionaryMap_Entry alloc]
...
- (jboolean)isEqual:(id)object {
  ...
  if ([object isKindOfClass:[ASDictionaryMap class]]) {
    ASDictionaryMap *otherASDictionaryMap = object;
    return [dictionary_ isEqualToDictionary:otherASDictionaryMap->dictionary_];
  }
