...
export abstract class RadioButtonStyledLabelImpl<T> extends ViewImpl<T>{
	//start - body
	static initialize() {
	...
	@Type(() => CommandAttr)
	@Expose({ name: "swtCheckBoxHorizontalPadding" })
	swtCheckBoxHorizontalPadding!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "text" })
	...
	reset() : T {	
		...
		this.swtCheckBoxHorizontalPadding = undefined;
		this.text = undefined;
	...
	public setSwtCheckBoxHorizontalPadding(value : string) : T {
		this.resetIfRequired();
		if (this.swtCheckBoxHorizontalPadding == null || this.swtCheckBoxHorizontalPadding == undefined) {
			this.swtCheckBoxHorizontalPadding = new CommandAttr<string>();
		}
		
		this.swtCheckBoxHorizontalPadding.setSetter(true);
		this.swtCheckBoxHorizontalPadding.setValue(value);
		this.orderSet++;
		this.swtCheckBoxHorizontalPadding.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
...
export class RadioButtonStyledLabel extends RadioButtonStyledLabelImpl<RadioButtonStyledLabel> implements IWidget{
    getThisPointer(): RadioButtonStyledLabel {
        return this;
    }
    
   	public getClass() {
		return RadioButtonStyledLabel;
	}
...
RadioButtonStyledLabelImpl.initialize();
