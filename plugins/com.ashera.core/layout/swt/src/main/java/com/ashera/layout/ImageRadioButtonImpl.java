...
@SuppressLint("NewApi")
public class ImageRadioButtonImpl extends BaseWidget implements IDrawable, ICustomMeasureHeight, ICustomMeasureWidth, IHasMultiNativeWidgets, IsRadioButton{
	//start - body
	public final static String LOCAL_NAME = "ImageRadioButton"; 
	...
	public void loadAttributes(String attributeName) {
		...
		ConverterFactory.register("ImageRadioButton.font", new Font());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("typeface").withType("ImageRadioButton.font").withUiFlag(UPDATE_UI_REQUEST_LAYOUT));
		ConverterFactory.register("ImageRadioButton.textStyle", new TextStyle());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("textStyle").withType("ImageRadioButton.textStyle").withUiFlag(UPDATE_UI_REQUEST_LAYOUT));
		...
		ConverterFactory.register("ImageRadioButton.ellipsize", new Ellipsize());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("ellipsize").withType("ImageRadioButton.ellipsize"));
		ConverterFactory.register("ImageRadioButton.marqueeRepeatLimit", new MarqueeRepeatLimit());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("marqueeRepeatLimit").withType("ImageRadioButton.marqueeRepeatLimit"));
	...
	public ImageRadioButtonImpl() {
		super(GROUP_NAME, LOCAL_NAME);
	}

		
	public class ImageRadioButtonExt extends MeasurableCompoundButton implements ILifeCycleDecorator{
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
			...
			ViewImpl.setDrawableBounds(ImageRadioButtonImpl.this, l, t, r, b);
			ViewImpl.nativeMakeFrame(asNativeWidget(), l, t, r, b);
			replayBufferedEvents();
			canvas.reset();
			onDraw(canvas);
	        ViewImpl.redrawDrawables(ImageRadioButtonImpl.this);
			...
			if (isInvalidateOnFrameChange() && isInitialised()) {
				ImageRadioButtonImpl.this.invalidate();
			}
		}	
        ...
        public void drawableStateChanged() {
        	...
        	ViewImpl.drawableStateChanged(ImageRadioButtonImpl.this);
        }
		@Override
        ...
        public void setVisibility(int visibility) {
		  ...
		  public int getBorderPadding(){
		    return ImageRadioButtonImpl.this.getBorderPadding();
		  }

		  public int getLineHeight(){
		    return ImageRadioButtonImpl.this.getLineHeight();
		  }

		  public int getBorderWidth(){
		    return ImageRadioButtonImpl.this.getBorderWidth();
		  }
		  public int getLineHeightPadding(){
		    return ImageRadioButtonImpl.this.getLineHeightPadding();
		  }
	}	
	public void updateMeasuredDimension(int width, int height) {
		((ImageRadioButtonExt) measurableCompoundButton).updateMeasuredDimension(width, height);
	}

	@Override
	public IWidget newInstance() {
		return new ImageRadioButtonImpl();
	}
	...
	public void create(IFragment fragment, Map<String, Object> params) {
		...
		measurableCompoundButton = new ImageRadioButtonExt();
		nativeCreate(params);	
...
return getLastBaselineToBottomHeight();				}
    ...
    public List<Object> getNativeWidgets() {
		return java.util.Arrays.asList(wrapperComposite, label, drawableBottom, drawableLeft, drawableTop, drawableRight, image).
...
//		timer = null;
	...
	protected org.eclipse.swt.widgets.Label image;
	private void nativeCreate(Map<String, Object> params) {
		Composite parent = (Composite) ViewImpl.getParent(this);
		nativeCreateLabel(parent, params);
		image = new Label(wrapperComposite, getStyle("swtStyle", org.eclipse.swt.SWT.NONE, params, fragment));
		createCanvas();
	}
	...
	private void createCanvas() {
		canvas = new r.android.graphics.Canvas() {
			...
			public void draw(r.android.graphics.drawable.Drawable drawable) {
				image.setBounds(drawable.getLeft() + (defaultPadding/2), drawable.getTop(), drawable.getRight() - drawable.getLeft(), drawable.getBottom() - drawable.getTop());
			}
	...
	private void setButton(Object objValue) {
		if (image != null) {
			...
			} else if (drawable instanceof Color) {
				image.setBackground((Color) drawable);
				image.setImage(null);
			} else {
				image.setBackground(null);
				image.setImage(null);
...
public ImageRadioButtonBean getBean() {
	if (bean == null) {
		bean = new ImageRadioButtonBean();
	}
	return bean;
}
public ImageRadioButtonCommandBuilder getBuilder() {
	if (builder == null) {
		builder = new ImageRadioButtonCommandBuilder();
	}
	return builder;
}


public  class ImageRadioButtonCommandBuilder extends com.ashera.layout.ViewImpl.ViewCommandBuilder <ImageRadioButtonCommandBuilder> {
    public ImageRadioButtonCommandBuilder() {
	}
	
	public ImageRadioButtonCommandBuilder execute(boolean setter) {
		if (setter) {
...
public ImageRadioButtonCommandBuilder tryGetSwtImage() {
...
public ImageRadioButtonCommandBuilder setSwtImage(String value) {
	Map<String, Object> attrs = initCommand("swtImage");
	attrs.put("type", "attribute");
...
return this;}
public ImageRadioButtonCommandBuilder tryGetSwtText() {
...
public ImageRadioButtonCommandBuilder setSwtText(String value) {
	Map<String, Object> attrs = initCommand("swtText");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetChecked() {
...
public ImageRadioButtonCommandBuilder setChecked(boolean value) {
	Map<String, Object> attrs = initCommand("checked");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setOnCheckedChange(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setSwtCheckBoxHorizontalPadding(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetButton() {
...
public ImageRadioButtonCommandBuilder setButton(String value) {
	Map<String, Object> attrs = initCommand("button");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetText() {
...
public ImageRadioButtonCommandBuilder setText(String value) {
	Map<String, Object> attrs = initCommand("text");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetTextColor() {
...
public ImageRadioButtonCommandBuilder setTextColor(String value) {
	Map<String, Object> attrs = initCommand("textColor");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetGravity() {
...
public ImageRadioButtonCommandBuilder setGravity(String value) {
	Map<String, Object> attrs = initCommand("gravity");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetTextSize() {
...
public ImageRadioButtonCommandBuilder setTextSize(String value) {
	Map<String, Object> attrs = initCommand("textSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setPadding(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingBottom() {
...
public ImageRadioButtonCommandBuilder setPaddingBottom(String value) {
	Map<String, Object> attrs = initCommand("paddingBottom");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingRight() {
...
public ImageRadioButtonCommandBuilder setPaddingRight(String value) {
	Map<String, Object> attrs = initCommand("paddingRight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingLeft() {
...
public ImageRadioButtonCommandBuilder setPaddingLeft(String value) {
	Map<String, Object> attrs = initCommand("paddingLeft");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingStart() {
...
public ImageRadioButtonCommandBuilder setPaddingStart(String value) {
	Map<String, Object> attrs = initCommand("paddingStart");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingEnd() {
...
public ImageRadioButtonCommandBuilder setPaddingEnd(String value) {
	Map<String, Object> attrs = initCommand("paddingEnd");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetPaddingTop() {
...
public ImageRadioButtonCommandBuilder setPaddingTop(String value) {
	Map<String, Object> attrs = initCommand("paddingTop");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setPaddingHorizontal(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setPaddingVertical(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMinLines() {
...
public ImageRadioButtonCommandBuilder setMinLines(int value) {
	Map<String, Object> attrs = initCommand("minLines");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setLines(int value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMaxLines() {
...
public ImageRadioButtonCommandBuilder setMaxLines(int value) {
	Map<String, Object> attrs = initCommand("maxLines");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMinWidth() {
...
public ImageRadioButtonCommandBuilder setMinWidth(String value) {
	Map<String, Object> attrs = initCommand("minWidth");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMinHeight() {
...
public ImageRadioButtonCommandBuilder setMinHeight(String value) {
	Map<String, Object> attrs = initCommand("minHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMaxWidth() {
...
public ImageRadioButtonCommandBuilder setMaxWidth(String value) {
	Map<String, Object> attrs = initCommand("maxWidth");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMaxHeight() {
...
public ImageRadioButtonCommandBuilder setMaxHeight(String value) {
	Map<String, Object> attrs = initCommand("maxHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetHeight() {
...
public ImageRadioButtonCommandBuilder setHeight(String value) {
	Map<String, Object> attrs = initCommand("height");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetWidth() {
...
public ImageRadioButtonCommandBuilder setWidth(String value) {
	Map<String, Object> attrs = initCommand("width");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMaxEms() {
...
public ImageRadioButtonCommandBuilder setMaxEms(int value) {
	Map<String, Object> attrs = initCommand("maxEms");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMinEms() {
...
public ImageRadioButtonCommandBuilder setMinEms(int value) {
	Map<String, Object> attrs = initCommand("minEms");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setEms(int value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setTypeface(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setTextStyle(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setFontFamily(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableLeft(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableRight(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableStart(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableEnd(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableTop(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setDrawableBottom(String value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetDrawablePadding() {
...
public ImageRadioButtonCommandBuilder setDrawablePadding(String value) {
	Map<String, Object> attrs = initCommand("drawablePadding");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setMaxLength(int value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setEnabled(boolean value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setEditable(boolean value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setSingleLine(boolean value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setTextAllCaps(boolean value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setScrollHorizontally(boolean value) {
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetEllipsize() {
...
public ImageRadioButtonCommandBuilder setEllipsize(String value) {
	Map<String, Object> attrs = initCommand("ellipsize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetMarqueeRepeatLimit() {
...
public ImageRadioButtonCommandBuilder setMarqueeRepeatLimit(String value) {
	Map<String, Object> attrs = initCommand("marqueeRepeatLimit");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetFirstBaselineToTopHeight() {
...
public ImageRadioButtonCommandBuilder setFirstBaselineToTopHeight(String value) {
	Map<String, Object> attrs = initCommand("firstBaselineToTopHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder tryGetLastBaselineToBottomHeight() {
...
public ImageRadioButtonCommandBuilder setLastBaselineToBottomHeight(String value) {
	Map<String, Object> attrs = initCommand("lastBaselineToBottomHeight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ImageRadioButtonCommandBuilder setTextFormat(String value) {
...
public class ImageRadioButtonBean extends com.ashera.layout.ViewImpl.ViewBean{
		public ImageRadioButtonBean() {
			super(ImageRadioButtonImpl.this);
		}
public Object getSwtImage() {
