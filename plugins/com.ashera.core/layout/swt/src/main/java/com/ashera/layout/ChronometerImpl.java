...
@SuppressLint("NewApi")
public class ChronometerImpl extends BaseWidget implements IDrawable, IHasMultiNativeWidgets, ICustomMeasureHeight, ICustomMeasureWidth{
	//start - body
...
public ChronometerCommandBuilder tryGetSwtImage() {
...
public ChronometerCommandBuilder setSwtImage(String value) {
	Map<String, Object> attrs = initCommand("swtImage");
	attrs.put("type", "attribute");
...
return this;}
public ChronometerCommandBuilder tryGetSwtText() {
...
public ChronometerCommandBuilder setSwtText(String value) {
	Map<String, Object> attrs = initCommand("swtText");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
