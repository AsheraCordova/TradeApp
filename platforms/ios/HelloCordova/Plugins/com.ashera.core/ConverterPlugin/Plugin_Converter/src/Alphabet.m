...
- (id<ASValidation>)newInstanceWithNSStringArray:(IOSObjectArray *)argument {
  return create_ASAlphabet_init();
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ASAlphabet_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ASAlphabet = { "Alphabet", "com.ashera.validations", ptrTable, methods, NULL, 7, 0x1, 4, 0, -1, -1, -1, -1, -1 };
  return &_ASAlphabet;
}

@end

void ASAlphabet_init(ASAlphabet *self) {
  ASBaseValidator_init(self);
}

ASAlphabet *new_ASAlphabet_init() {
  J2OBJC_NEW_IMPL(ASAlphabet, init)
}

ASAlphabet *create_ASAlphabet_init() {
  J2OBJC_CREATE_IMPL(ASAlphabet, init)
}
