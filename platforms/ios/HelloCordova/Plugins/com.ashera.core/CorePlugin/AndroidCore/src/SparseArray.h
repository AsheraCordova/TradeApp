 ...
 */
@interface ADSparseArray : NSObject < NSCopying >
...
J2OBJC_STATIC_INIT(ADSparseArray)

FOUNDATION_EXPORT void ADSparseArray_init(ADSparseArray *self);

FOUNDATION_EXPORT ADSparseArray *new_ADSparseArray_init(void) NS_RETURNS_RETAINED;
