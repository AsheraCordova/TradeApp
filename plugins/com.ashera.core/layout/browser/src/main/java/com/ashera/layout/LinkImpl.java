...
public class LinkImpl extends BaseWidget {
	...
	public class LinkExt extends MeasurableTextView implements ILifeCycleDecorator{
        ...
        public int nativeMeasureWidth(java.lang.Object uiView) {
        	return LinkImpl.this.nativeMeasureWidth(uiView);
        }
        
        @Override
        public int nativeMeasureHeight(java.lang.Object uiView, int width) {
        	return LinkImpl.this.nativeMeasureHeight(uiView, width);
        }
	}	
	public void updateMeasuredDimension(int width, int height) {
	}
...
return getLineSpacingMultiplier();				}
	...
	private void nativeCreateLabel(String rootTagName) {
    	...
    	label = org.teavm.jso.dom.html.HTMLDocument.current().createElement("a");
...
public void setTextFormat(String value) {
	...
	private void nativeCreate(Map<String, Object> params) {
		...
		label.getStyle().setProperty("text-decoration", "underline");
		label.getStyle().setProperty("color", "inherit");
		label.setAttribute("href", "javascript:;");
		hTMLElement.getStyle().setProperty("cursor", "pointer");
	}
}
