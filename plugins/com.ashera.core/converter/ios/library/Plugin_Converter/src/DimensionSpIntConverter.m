...
@implementation ASDimensionSpIntConverter

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  ASDimensionSpIntConverter_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ASDimensionSpIntConverter = { "DimensionSpIntConverter", "com.ashera.converter", ptrTable, methods, NULL, 7, 0x1, 4, 0, -1, -1, -1, 6, -1 };
  return &_ASDimensionSpIntConverter;
}

@end

void ASDimensionSpIntConverter_init(ASDimensionSpIntConverter *self) {
  NSObject_init(self);
}

ASDimensionSpIntConverter *new_ASDimensionSpIntConverter_init() {
  J2OBJC_NEW_IMPL(ASDimensionSpIntConverter, init)
}

ASDimensionSpIntConverter *create_ASDimensionSpIntConverter_init() {
  J2OBJC_CREATE_IMPL(ASDimensionSpIntConverter, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASDimensionSpIntConverter)
