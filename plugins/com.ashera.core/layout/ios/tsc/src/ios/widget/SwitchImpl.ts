...
export abstract class SwitchImpl<T> extends ViewImpl<T>{
	...
	@Type(() => CommandAttr)
	@Expose({ name: "iosIsOn" })
	iosIsOn!:CommandAttr<boolean>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "iosOnTintColor" })
	iosOnTintColor!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "iosThumbTintColor" })
	iosThumbTintColor!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "iosOnImage" })
	iosOnImage!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	@Expose({ name: "iosOffImage" })
	iosOffImage!:CommandAttr<string>| undefined;
	@Type(() => CommandAttr)
	...
	reset() : T {	
		...
		this.iosIsOn = undefined;
		this.iosOnTintColor = undefined;
		this.iosThumbTintColor = undefined;
		this.iosOnImage = undefined;
		this.iosOffImage = undefined;
	...
	public tryGetIosIsOn() : T {
		this.resetIfRequired();
		if (this.iosIsOn == null || this.iosIsOn == undefined) {
			this.iosIsOn = new CommandAttr<boolean>()
		}
		
		this.iosIsOn.setGetter(true);
		this.orderGet++;
		this.iosIsOn.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public isIosIsOn() : boolean {
		if (this.iosIsOn == null || this.iosIsOn == undefined) {
			this.iosIsOn = new CommandAttr<boolean>();
		}
		return this.iosIsOn.getCommandReturnValue();
	}
	public setIosIsOn(value : boolean) : T {
		this.resetIfRequired();
		if (this.iosIsOn == null || this.iosIsOn == undefined) {
			this.iosIsOn = new CommandAttr<boolean>();
		}
		
		this.iosIsOn.setSetter(true);
		this.iosIsOn.setValue(value);
		this.orderSet++;
		this.iosIsOn.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetIosOnTintColor() : T {
		this.resetIfRequired();
		if (this.iosOnTintColor == null || this.iosOnTintColor == undefined) {
			this.iosOnTintColor = new CommandAttr<string>()
		}
		
		this.iosOnTintColor.setGetter(true);
		this.orderGet++;
		this.iosOnTintColor.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getIosOnTintColor() : string {
		if (this.iosOnTintColor == null || this.iosOnTintColor == undefined) {
			this.iosOnTintColor = new CommandAttr<string>();
		}
		return this.iosOnTintColor.getCommandReturnValue();
	}
	public setIosOnTintColor(value : string) : T {
		this.resetIfRequired();
		if (this.iosOnTintColor == null || this.iosOnTintColor == undefined) {
			this.iosOnTintColor = new CommandAttr<string>();
		}
		
		this.iosOnTintColor.setSetter(true);
		this.iosOnTintColor.setValue(value);
		this.orderSet++;
		this.iosOnTintColor.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetIosThumbTintColor() : T {
		this.resetIfRequired();
		if (this.iosThumbTintColor == null || this.iosThumbTintColor == undefined) {
			this.iosThumbTintColor = new CommandAttr<string>()
		}
		
		this.iosThumbTintColor.setGetter(true);
		this.orderGet++;
		this.iosThumbTintColor.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getIosThumbTintColor() : string {
		if (this.iosThumbTintColor == null || this.iosThumbTintColor == undefined) {
			this.iosThumbTintColor = new CommandAttr<string>();
		}
		return this.iosThumbTintColor.getCommandReturnValue();
	}
	public setIosThumbTintColor(value : string) : T {
		this.resetIfRequired();
		if (this.iosThumbTintColor == null || this.iosThumbTintColor == undefined) {
			this.iosThumbTintColor = new CommandAttr<string>();
		}
		
		this.iosThumbTintColor.setSetter(true);
		this.iosThumbTintColor.setValue(value);
		this.orderSet++;
		this.iosThumbTintColor.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetIosOnImage() : T {
		this.resetIfRequired();
		if (this.iosOnImage == null || this.iosOnImage == undefined) {
			this.iosOnImage = new CommandAttr<string>()
		}
		
		this.iosOnImage.setGetter(true);
		this.orderGet++;
		this.iosOnImage.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getIosOnImage() : string {
		if (this.iosOnImage == null || this.iosOnImage == undefined) {
			this.iosOnImage = new CommandAttr<string>();
		}
		return this.iosOnImage.getCommandReturnValue();
	}
	public setIosOnImage(value : string) : T {
		this.resetIfRequired();
		if (this.iosOnImage == null || this.iosOnImage == undefined) {
			this.iosOnImage = new CommandAttr<string>();
		}
		
		this.iosOnImage.setSetter(true);
		this.iosOnImage.setValue(value);
		this.orderSet++;
		this.iosOnImage.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
		

	public tryGetIosOffImage() : T {
		this.resetIfRequired();
		if (this.iosOffImage == null || this.iosOffImage == undefined) {
			this.iosOffImage = new CommandAttr<string>()
		}
		
		this.iosOffImage.setGetter(true);
		this.orderGet++;
		this.iosOffImage.setOrderGet(this.orderGet);
		return this.thisPointer;
	}
	
	public getIosOffImage() : string {
		if (this.iosOffImage == null || this.iosOffImage == undefined) {
			this.iosOffImage = new CommandAttr<string>();
		}
		return this.iosOffImage.getCommandReturnValue();
	}
	public setIosOffImage(value : string) : T {
		this.resetIfRequired();
		if (this.iosOffImage == null || this.iosOffImage == undefined) {
			this.iosOffImage = new CommandAttr<string>();
		}
		
		this.iosOffImage.setSetter(true);
		this.iosOffImage.setValue(value);
		this.orderSet++;
		this.iosOffImage.setOrderSet(this.orderSet);
		return this.thisPointer;
	}
