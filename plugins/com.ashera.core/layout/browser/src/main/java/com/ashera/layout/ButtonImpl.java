...
public class ButtonImpl extends BaseWidget {
	...
	public class ButtonExt extends MeasurableTextView implements ILifeCycleDecorator{
        ...
        public int nativeMeasureWidth(java.lang.Object uiView) {
        	return ButtonImpl.this.nativeMeasureWidth(uiView);
        }
        
        @Override
        public int nativeMeasureHeight(java.lang.Object uiView, int width) {
        	return ButtonImpl.this.nativeMeasureHeight(uiView, width);
        }
	}	
	public void updateMeasuredDimension(int width, int height) {
	}
...
return getTextColorHighlight();				}
	...
	private int computeSize(float width) {
		return measurableTextView.nativeMeasureHeight(hTMLElement, (int) width);
	}
...
public ButtonCommandBuilder setEllipsize(String value) {
	Map<String, Object> attrs = initCommand("ellipsize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public ButtonCommandBuilder setShadowRadius(float value) {
	...
	attrs.put("value", value);
return this;}
public ButtonCommandBuilder tryGetTextIsSelectable() {
...
public ButtonCommandBuilder setTextIsSelectable(boolean value) {
	Map<String, Object> attrs = initCommand("textIsSelectable");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public ButtonCommandBuilder setLineSpacingMultiplier(float value) {
	...
	attrs.put("value", value);
return this;}
public ButtonCommandBuilder tryGetTextColorHighlight() {
...
public ButtonCommandBuilder setTextColorHighlight(String value) {
	Map<String, Object> attrs = initCommand("textColorHighlight");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public ButtonCommandBuilder setTextColorLink(String value) {
