...
public RadioButtonCommandBuilder tryGetSwtImage() {
...
public RadioButtonCommandBuilder setSwtImage(String value) {
	Map<String, Object> attrs = initCommand("swtImage");
	attrs.put("type", "attribute");
...
return this;}
public RadioButtonCommandBuilder tryGetSwtText() {
...
public RadioButtonCommandBuilder setSwtText(String value) {
	Map<String, Object> attrs = initCommand("swtText");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public RadioButtonCommandBuilder setOnCheckedChange(String value) {
	...
	attrs.put("value", value);
return this;}
public RadioButtonCommandBuilder setSwtCheckBoxHorizontalPadding(String value) {
