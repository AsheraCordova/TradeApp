...
public HorizontalScrollViewCommandBuilder setOnScrollChange(String value) {
	...
	attrs.put("value", value);
return this;}
public HorizontalScrollViewCommandBuilder setIosPreventAutoScroll(boolean value) {
	Map<String, Object> attrs = initCommand("iosPreventAutoScroll");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public void setIosPreventAutoScroll(boolean value) {
	getBuilder().reset().setIosPreventAutoScroll(value).execute(true);
}
