...
@interface ASUIScrollView () {
@public
	//start - props
	//end - props
}
@end
@implementation ASUIScrollView {
}
//start - body
...
//https://github.com/vasvf/NPInfiniteScrollView/blob/master/class/NPInfiniteScrollView.m
-(void)setContentOffset:(CGPoint)contentOffset {
	if (self.infiniteScroll == YES) {
	    BOOL hasHorizontalScroll = self.contentSize.width>self.frame.size.width;
	    BOOL hasVerticalScroll = self.contentSize.height>self.frame.size.height;
